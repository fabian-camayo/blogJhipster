...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'B2C', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2022-06-30T23:16:22.555Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-07-01T00:40').should('have.value', '2022-07-01T00:40');
